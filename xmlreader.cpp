            ...
            if(m.tagName() == "Facility") {
                ...
                if (m.attributes().count() > 3){
                    if (n.firstChild().childNodes().count() > 0){
                        readRebuildRequest(aRequest);
                    }
                    else{
                        return readAddRemoveFacility(aRequest, type);
                    }
                }
                else if(m.attributes().count() > 1){
                ...
                if (readRebuildRequest(aRequest) == "-1");
                {
...
QString XMLReader::buildFacilityMismatchDifference(QString occCare, QString reqCare, QString datePlacedOnWaitingList, QString AC, QString CCC, QString LTC, QString date, QString type)
{
    ...
    if (reqCare == "3"){reqCare = "2";}
    if (reqCare == "2"){reqCare = "1";}
    if (reqCare == "1"){reqCare = "0";}
                                ...
                                while(!patients.isNull()){
                                    if(patientsElement.tagName() == "Patient") {
                                        ...
                                        if (hasWaitingList == true){
                                            ...
                                            if (MapWinCtrl::getInstance()->getWlArray(areaID.toInt()) == 0){
